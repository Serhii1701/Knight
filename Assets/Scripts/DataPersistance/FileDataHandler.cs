...
public class FileDataHandler
{
    ...
    public GameData Load(string profileId, bool allowRestoreFromBackup = true)
    {
        ...
        if (File.Exists(fullPath))
        {
            ...
            {
                // since we're calling Load(...) recursively, we need to aacount for the case when
                // the roll back succeeds, but data is still failing to load for some other reason,
    ...
    public void Save(GameData data, string profileId)
    {
        ...
        try
        {
            //create the directory the file will be written to it if it doesn't already exist
            ...
            //verify the newly saved game can be loaded successfully
    ...
    public void Delete(string profileId)
    {
        ...
        try
        {
            //ensure tge data file exists at this path before deleting the directory
            if (File.Exists(fullPath))
            {
            ...
            {
                Debug.LogError("Tried to delete profile data, but data wos not found at path: " + fullPath);
            }
        }
        catch (Exception e)
        {
    ...
    public Dictionary<string, GameData> LoadAllProfiles()
    {
        ...
        foreach (DirectoryInfo dirInfo in dirInfos)
        {
            ...
            {
                Debug.LogError("Tried to load profile but something went wrong. Profiled: " + profileId);
            }
        }
    ...
    public string GetMostRecetlyUpdatedProfileId()
    {
    ...
    private bool AttemptRollBack(string fullPath)
    {
        ...
        try
        {
            ...
            //otherwise, we don't have yet a backup file - so there's nothing to roll back to
            else
            {
